...
const styles = StyleSheet.create({
  ...
  live: { color: "#008536", fontFamily: "NunitoSans_800ExtraBold", fontSize: 12 },
  link: { color: colors.accent, fontFamily: "NunitoSans_800ExtraBold" },
  title: { fontFamily: "Nunito_800ExtraBold", fontSize: 32, color: colors.ink },
  sub: { fontFamily: "NunitoSans_400Regular", color: colors.inkDim },
  track: {
    height: 6,
    borderRadius: 99,
  ...
  badgeEmpty: { backgroundColor: "#fef3f2" },
  badgeText: { color: colors.accent, fontFamily: "NunitoSans_800ExtraBold", fontSize: 16 },
  section: {
    marginTop: 12,
    fontSize: 12,
    letterSpacing: 1,
  ...
  overlay: { flex: 1, backgroundColor: "rgba(28,43,36,0.35)" },
  sheet: {
    backgroundColor: "#ffffff",
  ...
  stepGlyph: { color: colors.ink, fontSize: 28, fontFamily: "NunitoSans_600SemiBold" },
  qty: {
    fontFamily: "Nunito_800ExtraBold",
    fontSize: 36,
    color: colors.ink,
  ...
  error: { color: colors.danger, fontFamily: "NunitoSans_600SemiBold", marginBottom: 8 },
  btnPrimary: {
    minHeight: 54,
    borderRadius: 999,
