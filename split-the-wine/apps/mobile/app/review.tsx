...
const styles = StyleSheet.create({
  ...
  narrow: { width: 56 },
  price: { width: 88 },
  link: { color: colors.gold, fontFamily: "DMSans_700Bold", marginVertical: 6 },
  muted: { color: colors.inkDim, fontFamily: "DMSans_400Regular", marginTop: 8 },
  money: { color: colors.ink, fontFamily: "DMSans_700Bold" },
  btnPrimary: {
    marginTop: 16,
    minHeight: 54,
    borderRadius: 18,
