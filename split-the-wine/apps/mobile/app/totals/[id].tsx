...
const styles = StyleSheet.create({
  ...
  rowTitle: { color: colors.ink, fontFamily: "NunitoSans_800ExtraBold", fontSize: 16 },
  muted: { color: colors.inkDim, fontFamily: "NunitoSans_400Regular", marginTop: 4 },
  money: { color: colors.ink, fontFamily: "NunitoSans_800ExtraBold", fontSize: 18 },
  btnSecondary: {
    minHeight: 48,
    borderRadius: 16,
    borderWidth: 2,
  ...
  btnSecondaryText: { color: colors.primaryDeep, fontFamily: "NunitoSans_800ExtraBold" },
